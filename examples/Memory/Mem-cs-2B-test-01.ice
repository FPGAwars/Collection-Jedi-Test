{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "b8ac315e-9fc7-4ac6-845e-bfa230be0360",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "62449e50-b94c-4d46-9715-c231569f7d30",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Mem-cs-2B Test 1: LEDs\n\nTesting the 2 Bytes memory  \nA two stated sequence is shown in the leds  \n",
            "readonly": true
          },
          "position": {
            "x": 376,
        ...
        {
          "id": "09dd5b31-bbea-438d-9002-f2e36df2ce83",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "b8ac315e-9fc7-4ac6-845e-bfa230be0360",
            "port": "in"
          },
          "size": 8
        },
        {
          "source": {
            "block": "62449e50-b94c-4d46-9715-c231569f7d30",
        ...
        {
          "source": {
            "block": "09dd5b31-bbea-438d-9002-f2e36df2ce83",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "5cecbda9-0f79-4240-ae95-796257d72825",
